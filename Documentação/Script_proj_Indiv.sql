...
select nomePersonagem, historiaPersonagem, raca, classe, valorURL, idPersonagem from personagem join apendise on fkApendise = idapendise where fkUsuario ='1';
select * from apendise;
select * from apendise where raca ='Anão' AND classe = 'Barbaro';
select * from apendise where raca ='Anão';
